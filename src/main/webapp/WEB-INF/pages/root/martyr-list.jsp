		...
		<table id="table-common">
			...
			<tbody>
				<tr>
					...
					<td>Xóm Hạ - Nam Tân - Nam Trực - Nam Định</td>
					<td><a href="#deleteEmployeeModal" class="delete float-right"
						data-toggle="modal"> <i class="far fa-check" title="Xóa"
				...
				<tr>
					...
					<td>22/09/1956</td>
					<td>Nam</td>
					<td>Xóm Thượng - Nam Tân - Nam Trực - Nam Định</td>
					<td>Xóm Thượng - Nam Tân - Nam Trực - Nam Định</td>
					<td><a href="#deleteEmployeeModal" class="float-right"
						data-toggle="modal"> <i class="fa-check" title="Duyệt"
							data-toggle="modal" data-target="#frmCreate"
							data-backdrop="static" data-keyboard="false"></i>
					</a></td>
				</tr>
